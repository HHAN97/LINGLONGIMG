document.getElementById('year').textContent = new Date().getFullYear();
    ...
    const products = [
      ...
      {brand:"TORRIDEN", name:"Torriden DIVE-IN LOW MOLECULAR HYALYRONC ACID MASK 10PC Torriden 深水低分子玻尿酸补水面膜 10片装", price:25, old:32, img:"LINGLONG/Torriden DIVE-IN LOW MOLECULAR HYALYRONC ACID MASK 5+1PC.webp"},

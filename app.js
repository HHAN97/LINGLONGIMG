document.getElementById('year').textContent = new Date().getFullYear();
    ...
    const products = [
      ...
      {brand:"ANUA", name:"Anua Niacinamide10% + Txa 4% Dark Spot Removing Serum 30Ml ANUA 烟酰胺10% + TXA 4% 淡斑精华液 30ml", price:29, old:36, img:"LINGLONG/anua_niacinamide10%_Txa_4%_dark_spot_removing_serum_30m.jpg"},
